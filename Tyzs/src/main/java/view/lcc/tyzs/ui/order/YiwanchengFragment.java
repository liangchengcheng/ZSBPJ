...
import view.lcc.tyzs.adapter.YiwanchengAdapter;
 ...
 * Description:  |未支付的订单
 */
public class YiwanchengFragment extends Fragment implements GetOrderView, SwipeRefreshLayout.OnRefreshListener
        , YiwanchengAdapter.OnItemClickListener {
    private LoadingLayout loading_layout;
    private YiwanchengAdapter mAdapter;
    ...
    private static final String TYPE = "已完成";
    ...
    private void initRecycleView(View view) {
        ...
        mAdapter = new YiwanchengAdapter();

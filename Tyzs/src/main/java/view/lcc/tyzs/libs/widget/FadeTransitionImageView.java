package view.lcc.tyzs.libs.widget;
...
public class FadeTransitionImageView extends BaseTransitionLayoutForImage {
    ...
    @Override
    public void saveNextPosition(int position, int url) {

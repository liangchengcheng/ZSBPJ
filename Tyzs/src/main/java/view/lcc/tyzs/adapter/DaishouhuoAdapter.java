 ...
 */
public class DaishouhuoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnSureClickListener {
        void OnSureClick(OrderInfoData data);
    }

    private OnSureClickListener listener;

    public void setOnSureClickListener(OnSureClickListener li) {
        this.listener = li;
    }

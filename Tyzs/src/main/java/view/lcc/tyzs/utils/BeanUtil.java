...
public class BeanUtil {
    ...
    public static List<News> getNewsData(){
        ...
        news1.setTiaoli_content("痰湿之生，若因脾不健运，湿聚成痰者，当健脾化痰。脾主四肢，足居于下，多为湿所侵，以致腰脊膝痛而成痹，脾气得补，则湿自不容留，前症皆除。五行素食，淡能利窍，祛湿则逐水燥脾，厚肠藏，祛邪水，补真水，治痰之本。若因寒聚湿，可根据阳虚质增以蕴煦正本汤以阳化湿。");
        dataList.add(news1);
        ...
        news2.setYingxiang_content(
                "阳气有温暖肢体、脏腑的作用，如果阳虚则机体功能减退，容易出现虚寒的征象。常见的有胃阳虚、脾阳虚、肾阳虚等。阳虚日久，则会导致阴寒内胜、卫外不固、气化无力，易患感冒、咳喘、泄泻、肿胀、阳痿、遗尿、郁证、痛经等疾病，免疫功能的紊乱，免疫监视功能降低，炎性细胞因子相关基因表达上调。");
        news2.setTiaoli("阳虚的调理？");
        news2.setTiaoli_content("阳虚的一般证候畏寒怕冷，四肢不温；完谷不化；精神不振；舌淡而胖，或有齿痕；脉象沉细外，特定脏器兼证可供辨别。蕴煦正本汤，能引导阳气，调和营卫之气，助气上行阳道。能导引阳气宣通血脉，使气血同行。散寒邪而利气，下达暖丹田，壮元阳，补相火。为诸药之使引，因其香窜之气，内而脏腑筋骨，外而经络腠理，倏忽之间莫不周遍，故诸药莫不透达之处，有此引之，莫不透达，一切虚寒致病并宜治之。特别适于阳虚质及相关衍生体质。\n");
        dataList.add(news2);
        ...
        news3.setYingxiang_content(
                "由于阴液亏少，机体失去濡润滋养物质，而阴不制阳，则阳热之气相对偏旺而生内热，故表现为一派虚热干燥不润、虚火躁扰不宁的证候。若阴虚日久，则会导致易生皱纹，易患久咳、不寐、噎膈、胸痹、便秘、盗汗、内伤发热等症，易患肺痨、高血压、中风、消渴（糖尿病）、高脂血症、哮喘、肺结核、冠心病、脑血管疾病、风湿类风湿等疾病。");
        news3.setTiaoli("阴虚的调理？");
        news3.setTiaoli_content(
                "阴虚的人应该多吃一些生津添精的食物，以滋阴潜阳为法。雪和正本汤，入脾、肺、肾三经，为补中宫之胜品，能补肾填精，增加体内的精液和津液，宽中益气，益血益气，使五脏调和，肌肉充盛，骨骼坚强，是补阴之胜品，特别适用阴虚质及其衍生体质的调理。");
        dataList.add(news3);
        ...
        news4.setYingxiang_content(
                "若气郁日久，则会导致肝气郁结，横逆犯所致胃脘痛；气逆于上所致的头痛、头目昏眩、面色晦滞、目赤、眼干、口苦口酸、吞之不下、咯之不出、恶心喜呕，吐血；暴怒伤肝，气乱血动，血液妄行，致成崩漏；经前乳房胀痛，郁结不孕；心不得主志，肝不得主谋虑，情志所伤，脏躁失养，心神惑乱，精神抑郁，健忘，失眠，多梦，惊恐，易发郁证、脏躁、百合病、梅核气、胁痛等疾病。" );
        news4.setTiaoli("气郁的调理？");
        news4.setTiaoli_content(
                "根据气郁的发生机理，要打破气郁加重机制，要提高心、肝的自我调节功能，而这些功能的实现都靠心和肝的营卫充足方能正常。心、肝皆以血为养，故用益心血补血疏肝是调理气郁的根本。雪和正本汤，能生津填精，生髓生血，用益心血，籍香以透心气，得温以助心神，凡志苦伤血，用智损神，致心虚不足，精神失守，惊悸怔仲，恍惚多忘，虚汗烦渴，所当必用。又取香温以肝胆，若胆虚血少，心烦不寐，用此肝胆血足，则五脏安和，睡卧得宁，特别适于气郁质。");
        dataList.add(news4);
        ...
        news5.setJili_content("湿与热合并入侵人体，或因湿久留不除而化热。不同的病因在不同的个体会引起不同的湿热证，如郁而化热，导致湿热郁阻肝胆，形成肝胆湿热证；如过食肥甘酒酪，酿湿生热，湿热内蕴中焦，形成脾胃湿热证；若湿热侵袭大肠，胶结不解，壅阻气机，则成大肠证；若湿热之邪，下注膀胱，膀胱气化不利，小便异常，则成膀胱湿热证；若湿热流注关节，关节局部红肿热痛，则形成湿热痹证；若湿热之邪流注淋巴经络，则形成淋巴结肿大结节。");
        news5.setYingxiang("湿热对人体的影响？");
        news5.setYingxiang_content(
                "若肝胆热证，则易发黄疸、牙痛、牙龈发炎、胆囊炎、偏头疼、胸痹、胆及胆囊结石及肝胆疾病；若脾胃形成湿热则易发复发性口腔溃疡；若湿热侵犯大肠，则大便黏腻解不尽；若湿热侵犯尿路及膀胱，则易发前列腺炎、膀胱炎、尿毒症、尿路结石等泌尿系统疾病；若湿困热不易散发，则容易患湿疹、青春痘、脚气、股癣、疮疖；若湿热伤肾，则易发脂溢性脱发、痿证；若湿热流注淋巴，则易侵犯免疫系统，易患淋巴系统疾病。");
        news5.setTiaoli("湿热的调理？");
        news5.setTiaoli_content(
                "湿热的调理，故人调理主要围绕“湿”和“热”来调，却不知阴虚血亏所致干热之生，雪和正本汤既生津生精生血，又利湿清热，利湿则需健脾，清热需要利达。若湿热引发炎症，则应辅以杀菌的消炎药。雪和正本汤具有利湿清热之功，同时补真阴补真水益真血，利湿而不泄气，利湿而不伤阴，能益气生津生精生血，清热而不伤脾胃，特别适于湿热质。");
        dataList.add(news5);
        ...
        news6.setTiaoli_content(
                "气虚多由阴虚、阳虚、消化不良食谷不化等多种原因导致，该体质为结果性体质。因此，气虚要在辨识其他体质的基础上配伍调理。");
        dataList.add(news6);
        ...
        news7.setTiaoli_content(
                "“气为血之帅”，气病则血瘀，影响气机的有阴有阳有痰。因此，在明确辩证体质的基础上，进行阴阳调和、利湿清瘀是调理血瘀之本，活血化瘀是调理之标。因此，在体质辩证的基础上调和阴阳综合调理体质，同时辅以菌酶多行血化瘀为上上之策。\n");
        dataList.add(news7);

...
public class ZSAdapter extends LoadMoreRecyclerAdapter<ZSTest,ZSAdapter.ViewHolder>{
    ...
    public ZSAdapter(Activity activity){
        this.mActivity=activity;
    }

    @Override
    public ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.zstest_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindItemViewHolder(ViewHolder holder, final int position) {
        ZSTest entity=getItem(position);
    ...
    public interface OnItemClickListener{
        void OnItemClick(ZSTest entity);
    }
}

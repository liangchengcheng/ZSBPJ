...
public class CodeFragment extends RefreshAndLoadFragment implements CodeAdapter.OnItemClickListener {
    ...
    protected void onFragmentCreate() {
        ...
        mAdapter = new CodeAdapter(getActivity());
        setAdapter(mAdapter);
    ...
    @Override
    public void OnItemClick(CodeEntity entity) {

    }

    private List<CodeEntity> getData(){
        List<CodeEntity> data=new ArrayList<>();
        for (int i=0;i<10;i++){
            CodeEntity zxTest=new CodeEntity();

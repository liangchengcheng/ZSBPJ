 ...
 * Description:
 */
public class VocationTestActivity extends BaseActivity implements ChoiceTypeView, View.OnClickListener {
    //添加了缓存
    ...
    public static void startVocationActivity(Activity startingActivity, String flag) {
        Intent intent = new Intent(startingActivity, VocationTestActivity.class);
    ...
    protected void initView() {
        mACache = ACache.get(VocationTestActivity.this);
    ...
    public void showPopupWindow() {
        ...
        final LeftAdapter leftAdapter = new LeftAdapter(VocationTestActivity.this, dataLeft);
    ...
    public void getDataSuccess2(String msg) {
        try {
            ...
            if (lv2.getVisibility() == View.INVISIBLE) {
                ...
                rightAdapter = new RightAdapter(VocationTestActivity.this, rightData);
            }
    ...
    public void setDataSuccess() {
        ...
        toasts.show("设置成功", R.layout.choice_toast_item, R.id.content_toast, VocationTestActivity.this);

 ...
 * Description:  |我的收藏
 */
public class VideoFavActivity extends BaseActivity implements VideoFavView, SwipeRefreshLayout.OnRefreshListener
        ,VideoFavAdapter.OnItemClickListener, View.OnClickListener {
    ...
    private VideoFavPresenter mPresenter;
    ...
    public static void startVideoFavActivity(Activity startingActivity, String type) {
        Intent intent = new Intent(startingActivity, VideoFavActivity.class);
    ...
    private void initRecycleView() {
        ...
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(VideoFavActivity.this,
                LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mAdapter = new VideoFavAdapter();
    ...
    @Override
    public void loadMoreView(final List<Videofav> entities) {
        int delay = 0;

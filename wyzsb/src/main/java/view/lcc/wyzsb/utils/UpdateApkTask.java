...
import view.lcc.wyzsb.bean.UpdateInfo;
import view.lcc.wyzsb.frame.Propertity;
import view.lcc.wyzsb.view.UpdateDialog;


public class UpdateApkTask {
    public static final String UPDATE_APK_URL = AppConstants.BASE_URL + "/service/getupdateinfo";

...
public class BeanUtil {
    ...
    public static List<News> getNewsData(){
        ...
        news2.setTiaoli_content("阳虚体质一般因寒致病，应以散寒祛寒邪，壮元阳。而中医认为，阴可化阳，若阴虚日久也会致真阳不足，故阳虚体质的调理也在辩证综合体质的基础上进行调理，若阴阳同虚，须阴阳同补。男士选用五子汤，女士选用伊人舒。\n");
        dataList.add(news2);
        ...
        news3.setTiaoli_content(
                "阴虚的人应该多吃一些生津添精的食物，以滋阴潜阳为法，若阳虚生寒，也会令脾胃不健，消化不利，所以阴虚体质的调节，也应在辨识综合体质的基础上同时调阳虚健脾胃，才能达到补阴除虚的目的。福润雪和，入脾、肺、肾三经，为补中宫之胜品，能补肾填精，增加体内的精液和津液，宽中益气，益血益气，使五脏调和，肌肉充盛，骨骼坚强，是补阴之胜品，特别适用阴虚质及其衍生体质的调理。");
        dataList.add(news3);
        ...
        news4.setTiaoli_content("根据气郁的发生机理，要打破气郁加重机制，要提高心、肝的自我调节功能，而这些功能的实现都靠心和肝的营卫充足方能正常，心、肝皆以血为养，故用益心血补血疏肝是调理气郁的根本。而心肝营卫的平衡又取决于阴阳的节制，故气郁体质的调理也应在辨识综合体质的基础上加以调节。福润雪和，能生津填精，生髓生血，用益心血，籍香以透心气，得温以助心神，凡志苦伤血，用智损神，致心虚不足，精神失守，惊悸怔仲，恍惚多忘，虚汗烦渴，所当必用。又取香温以肝胆，若胆虚血少，心烦不寐，用此肝胆血足，则五脏安和，睡卧得宁，特别适于气郁质。");
        dataList.add(news4);
        ...
        news5.setTiaoli_content(
                "湿热的调理，故人调理主要围绕“湿”和“热”来调，却不知阴虚血亏所致干热之生，福润雪和既生津生精生血，又利湿清热，利湿则需健脾，清热需要利达。若湿热引发炎症，则应辅以杀菌的消炎药。若同时伴随寒邪侵体，消化不利，也应辨识综合体质，根据综合体质的情况进行认识调理。福润雪和具有利湿清热之功，同时补真阴补真水益真血，利湿而不泄气，利湿而不伤阴，能益气生津生精生血，清热而不伤脾胃，特别适于湿热质。");
        dataList.add(news5);
        ...
        news7.setTiaoli_content(
                "“气为血之帅”，气病则血瘀，影响气机的有阴有阳有痰。因此，在明确辩证体质的基础上，进行阴阳调和、利湿清瘀是调理血瘀之本，活血化瘀是调理之标。因此，在体质辩证的基础上调和阴阳综合调理体质，同时辅以福酶纳豆化瘀为上上之策。\n");
        dataList.add(news7);
        ...
        news8.setTiaoli_content("特病质若先天脏器受损或不足，则不易调理。若卫外不固，可在辨识综合体质的基础上进行体质的综合调理，若有免疫缺陷或药物致敏可辅以增强免疫能力。食用菌是国际公认的抗癌和长寿食品，是国际公认的免疫增强剂和激活剂，因此对于调理特禀质具有非常特殊的优势。\n" +
                "因此，综合调理所存在的各种体质并辅以食用菌瑞芝灵等产品进行调理。\n");
        dataList.add(news8);

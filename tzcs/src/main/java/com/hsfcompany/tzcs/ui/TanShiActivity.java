 ...
 * Description:  |
 */
public class TanShiActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.pb_next:
                ...
                userInfo.setTanshizhi(score);
                Intent intent = new Intent(TanShiActivity.this,YangXuActivity.class);

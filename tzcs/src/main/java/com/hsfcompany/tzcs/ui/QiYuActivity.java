 ...
 * Description:  |
 */
public class QiYuActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.pb_next:
                ...
                userInfo.setQiyuzhi(score);
                Intent intent = new Intent(QiYuActivity.this,ShiReActivity.class);

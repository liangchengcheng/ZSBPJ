 ...
 * Description:  |
 */
public class ShiReActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shire_activity);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.pb_next:
                ...
                userInfo.setShirezhi(score);
                Intent intent = new Intent(ShiReActivity.this,QiXuActivity.class);
